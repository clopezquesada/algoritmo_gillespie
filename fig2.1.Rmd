...
La función Malthus_Gillespie() implementa el algoritmo Gillespie para el enfoque
estocástico de este modelo de Malthus, partiendo de un estado inicial de la
población $X_0>0$, se tiene la transición $X \rightarrow X+1, \quad a=rX$
en este caso tenemos un crecimiento exponencial de la población, como veremos 
gráficamente más abajo.
