...
graficoA <- graficoA + labs(title = element_blank(), x = "Tiempo (s)", y = " Número de moléculas de la especie X")+    theme_minimal() +
...
graficoB <- graficoB + labs(title = element_blank(), x = "Tiempo (s)", y = " Número de moléculas de la especie Y")+ theme_minimal() +
 theme(legend.title=element_blank(),legend.position = "bottom",
      axis.title.x = element_text(size = 10),  
      axis.title.y = element_text(size = 10)) +
 scale_color_manual(values = c("Realización"="gray", "Sol. mod. det." = "red"),
